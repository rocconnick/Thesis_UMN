...
\begin{figure}
  ...
  \begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[width=0.55\textwidth,viewport=10 13 135 97, clip=true]{figures/cnn/featurePlotNuMuDIS}
    \caption*{\numu CC DIS event with with significant hadronic activity}
  \end{subfigure}%

  \begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[width=0.55\textwidth,viewport=10 13 135 97, clip=true]{figures/cnn/featurePlotNuMuQE}
  ...
  \begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[width=0.55\textwidth,viewport=10 13 135 97, clip=true]{figures/cnn/featurePlotNC}
