...
\column{0.5\textwidth}
    \begin{figure}
  \includegraphics[width=\textwidth]{stdmod.jpg}
  \end{figure}
\end{columns}
...
\frame
{
  ...
  \column{0.5\textwidth}
  \centering
  \includegraphics[height=0.37\textheight]{betaPretty.png}
  \column{0.5\textwidth}
  \centering
  \includegraphics[height=0.37\textheight]{betaspec.jpg}
  \end{columns}
  \gap
  \begin{itemize}
...
\begin{frame}
  ...
  \includegraphics[height=0.37\textheight, angle=-90]{ccMu.pdf}
  \column{0.5\textwidth}
  \centering
   \textcolor{custom_red}{Neutral Current}


  \includegraphics[height=0.37\textheight, angle=-90]{ncHad.pdf}
  \end{columns}
\gap
    \bangon
...
\column{0.5\textwidth}
\includegraphics[width=1\textwidth]{figures/osc_prob.png}
...
\includegraphics[width=1\textwidth]{figures/2detectors.png}
...
\frame
{
  \frametitle{NuMI}
	...
	\begin{figure} \includegraphics[width=0.85\textwidth]{numi.png} \end{figure}
\end{itemize}
...
\column{0.15\textwidth}
 \includegraphics[width=1.4\textwidth]{figures/cell.jpeg}
\column{0.02\textwidth}
~
\column{0.83\textwidth}

\centering
 \includegraphics[width=0.85\textwidth]{figures/schematic.jpg}
...
\column{0.5\textwidth}
\centering
 \includegraphics[height=0.85\textheight]{det_photos/det_front.jpg}

\column{0.5\textwidth}
\centering
 \includegraphics[height=0.85\textheight]{det_photos/det_side.jpg}
\end{columns}
\gap
...
\end{itemize}
	\begin{figure} \includegraphics[height=0.55\textwidth]{det_photos/ND.jpg} \end{figure}
}
...
{
  \frametitle{Near Detector}
	\begin{figure} \includegraphics[height=0.55\textwidth]{det_photos/meND_small.jpg} \end{figure}
}
...
\frame
{
 ...
 \begin{figure} \includegraphics[width=0.95\textwidth]{figures/eventtopology.pdf} \end{figure}
}
...
\frame
{
 ...
 \begin{figure} \includegraphics[width=0.9\textwidth]{evd_steps/evd_top_side.png} \end{figure}
}
...
\frame
{
 ...
 \begin{figure} \includegraphics[width=0.9\textwidth]{evd_steps/evd_beam_dir.png} \end{figure}
}
...
\frame
{
 ...
 \begin{figure} \includegraphics[width=0.9\textwidth]{evd_steps/evd_beam_dir_nu.png} \end{figure}
}
...
\frame
{
 ...
 \begin{figure} \includegraphics[height=0.9\textwidth, angle=-90]{evd_steps/evd_oneslicehit.pdf} \end{figure}
}
...
\begin{tikzpicture}[]
   % Place nodes
   \node [block, fill=emerald] (reco) {Reconstruction \\ \footnotesize{Pattern Recognition}};
...
\node[inner sep=0cm, below =2.5cm, below of=extrap, align=left] (fit)
    { \includegraphics[width=.45\textwidth]{figures/spectrum.png}};
...
\frame
{
 ...
 \begin{figure} \includegraphics[height=0.9\textwidth, angle=-90]{evd_steps/evd_hits.pdf} \end{figure}
}
...
\frame
{
 ...
 \begin{figure} \includegraphics[height=0.9\textwidth, angle=-90]{evd_steps/evd_slice.pdf} \end{figure}
}
...
\includegraphics[width=\textwidth]{evd_steps/slice.png}

\includegraphics[width=\textwidth]{evd_steps/hough.png}

\includegraphics[width=\textwidth]{evd_steps/vertex.png}

\includegraphics[width=\textwidth]{evd_steps/prongs.png}
...
\item X-view is on top, Y-view on bottom
\bangoff

\column{0.5\textwidth}
\centering
\includegraphics[width=1\textwidth]{maps/PixelMap_r1000005_s76_e86.png}
\end{columns}
...
\includegraphics[width=1\textwidth]{maps/PixelMap_r1000005_s76_e87.png}

\column{0.5\textwidth}

\includegraphics[width=1\textwidth]{maps/PixelMap_r1000005_s76_e88.png}
...
\frametitle{Convolutional Layers}
  ...
  \begin{columns}[c]
  \column{0.5\textwidth}
  \centering \includegraphics[width=0.7\textwidth]{figures/conv.png}
  \column{0.5\textwidth}
  \centering \includegraphics[width=0.7\textwidth]{figures/conv3d.png}
  \end{columns}
  \bangon
  \gap
...
\framesubtitle{Network-in-Network, ``Inception"}
  ...
  \begin{columns}[c]
  \column{0.5\textwidth}
  \centering \includegraphics[width=0.9\textwidth]{figures/inceptionnaive.pdf}
  \column{0.5\textwidth}
  \centering \includegraphics[width=0.9\textwidth]{figures/inceptionmodule.pdf}
  \end{columns}
  \bangon
  \gap
...
\frametitle{Architecture}
  ...
  \column{0.28\textwidth}
   \includegraphics[height=0.9\textheight]{figures/arch.pdf}
...
\frametitle{Classifier Output}
  \begin{center}
   \includegraphics[height=0.7\textwidth, angle=-90]{ang_plots/ang_dist.pdf}
  \end{center}
...
\frametitle{Selection Comparison}
  \begin{center}
   \includegraphics[height=0.7\textwidth, angle=-90]{ang_plots/cosmic_sig_osc.pdf}
  \end{center}
  \gap
  \bangon
