...
A shallower surface results in larger confidence intervals which fits
...
Poisson distributed fluctuations in the signal and Gaussian fluctuations
for each systematic error.
