...
The \numi Off-axis Neutrino Appearance Experiment (\nova) is designed to study neutrino
oscillation in the \numi (Neutrinos at the Main Injector) beam.
...
This work presents an approach novel to particle physics analysis
...
$\sin^2(\thetatth) = 0.43$ (with a statistically-degenerate compliment near
0.60)
and
