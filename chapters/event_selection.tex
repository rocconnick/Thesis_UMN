...
\section{Selected Spectrum}

The figures at the end of this chapter give many representations of the selected
events which will ultimately be used for analysis.
...
The two smallest distributions, \textit{CNN + Cuts} and
...
to the ND data.
This gives us our first glimpse at data from true neutrino interactions.
...
\end{center}
\caption{CNN  distribution for selected ND sample}{
words
}
...
\end{center}
\caption{hadE distribution for selected ND sample}{
words
}
...
\end{center}
\caption{hadNH distribution for selected ND sample}{
words
}
...
\end{center}
\caption{numuE distribution for selected ND sample}{
words
}
...
\end{center}
\caption{remid distribution for selected ND sample}{
words
}
...
\end{center}
\caption{slcNH distribution for selected ND sample}{
words
}
...
\end{center}
\caption{trkLe distribution for selected ND sample}{
words
}
