...
The Network-in-Network approach \cite{lin2013network} has been used to augment the learning capacity of convolution layers.  Rather  Convolutional filters have been augmented 



Network-in-network\cite{lin2013network} .... inception module \cite{szegedy2014going}

\cite{hinton2014dropout}
