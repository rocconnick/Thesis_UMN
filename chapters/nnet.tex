...
\end{equation}
Gradient in each layer is propagated through to previous layer through chain rule.  For output nodes using the mean-square error, equation \ref{rmse} gives:
\begin{equation}
