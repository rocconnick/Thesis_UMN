...
\begin{tikzpicture}[]
    ...
    \node [block, text width=3.0cm, fill=mygreen, left of=anchor, left=1cm] (xview) {X View};
    ...
    \node [block, text width=3.0cm, fill=mygreen, right of=anchor, right=1cm] (yview) {X View};
