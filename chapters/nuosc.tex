...
bottom to top, indicating a neutrino and some target exists
...
is either converted to a charged lepton in the CC case,
or remains a neutrino in the NC case.
The nuclear side of the interaction, however, can be far messier
...
The theory that describes this phenomenon is neutrino oscillation.
...
\begin{subfigure}[b]{0.45\textwidth}
        ...
        \end{subfigure}
\end{center}
\caption{Interactions which permit coherent scattering}{
...
predominantly pions and kaons that subsequently decay into neutrinos.
