...
upstream filters, a common practice
for image recognitions competitions \cite{krizhevsky2012imagenet} is to
fine-tune downstream layers using pre-trained filters.
That fine-tuning approach was used in this case to make use of the training
...
After 970,000 total iterations, 1.9 million events from cosmic ray data were
added to the training example.
...
The cosmic ray preselection will be described in chapter
