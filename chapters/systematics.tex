...
of hadrons produced in the target.
...
standard FLUKA cross-section model configuration to an alternative tune
...
This alternative tune leads to a relatively large systematic error band
...
\item Beam position on target shifted by $\pm$0.5 mm in $X$ and $Y$
\item Beam spot size on target shifted by $\pm$0.2 mm in $X$ and $Y$
...
in when forming the FD prediction.
